...
function update(){
  ...
  if(counter3 === 0) smooth_loss = loss;
  else smooth_loss = 0.99*smooth_loss + 0.01*loss;

  var t = '';
  t += 'loss: ' + smooth_loss;
  t += '<br>'
  t += 'iteration: ' + counter3;
  $("#report3").html(t);
}

function draw() {
  if(counter3 % mod_skip_draw !== 0) return;
...
function refreshSwatch() {
  var lr = $("#slider3").slider("value");
  trainer.learning_rate = Math.pow(10, lr);
  $("#lr3").html('Learning rate: ' + trainer.learning_rate);
}

var ori_canvas, nn_canvas, ori_ctx, nn_ctx, oridata;
var sz = 150; // size of our drawing area
var counter3 = 0;
$(function() {
    ...
    image.onload = function() {
      ...
      nn_canvas = document.getElementById('canv_net3');
      ori_canvas.width = sz;
...
},{"convnetjs":2,"jquery":4,"jquery-ui":3}],2:[function(require,module,exports){
