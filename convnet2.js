...
function update(){
  ...
  if(counter2 === 0) smooth_loss = loss;
  else smooth_loss = 0.99*smooth_loss + 0.01*loss;

  var t = '';
  t += 'loss: ' + smooth_loss;
  t += '<br>'
  t += 'iteration: ' + counter2;
  $("#report2").html(t);
}

function draw() {
  if(counter2 % mod_skip_draw !== 0) return;
...
function refreshSwatch() {
  var lr = $("#slider2").slider("value");
  trainer.learning_rate = Math.pow(10, lr);
  $("#lr2").html('Learning rate: ' + trainer.learning_rate);
}
...
$(function() {
    ...
    image.onload = function() {
      ...
      nn_canvas = document.getElementById('canv_net2');
      ori_canvas.width = sz;
